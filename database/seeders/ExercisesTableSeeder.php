...
class ExercisesTableSeeder extends Seeder
{
    public function run(): void
    {
        $exerciseData = [
            ...
            ['Face Pull', 'Deltoides posteriores, Trapecios'],
            ...
            ['Peso Muerto Rumano Máquina Smith', 'Isquiotibiales'],
            ...
            ['Press de Banca Inclinado con Barra', 'Pectorales superiores'],
            ...
            ['Remo Sentado en Polea', 'Dorsales, Bíceps'],
